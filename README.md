...
- `audit_report.md` — Package audit findings (Part 1)
- `dependency_analysis.md` — Spec output, dependency graph, and blocker list (Part 2)
- `dependency_analysis.png` — Visual dependency graph (Part 2)
- `mock_pr.md` — Mock PR for k4fwcore (Part 3)
- `action_plan.md` — Prioritization strategy (Part 4)
